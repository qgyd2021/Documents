...
$\begin{align} \sin (x + \psi) &= \sin x \cos \psi + \cos x \sin \psi \\ &= a \sin x + b \cos x \\ & \text{其中 $a = \cos \psi, b = \sin \psi. $} \end{align}$ 
...
$\begin{align} e^{ix} + e^{-ix}&= 2 \cos x \\ \cos x &= \frac{e^{ix} + e^{-ix}}{2} \end{align}$

两式相减:

$\begin{align} e^{ix} - e^{-ix}&= 2 i \sin x \\ \sin x &= \frac{e^{ix} - e^{-ix}}{2i} \end{align}$
...
已知: $$\begin{aligned}A_{k} \cos \psi_{k} = \frac{1}{l} \int_{- l}^{l} {f(t) \sin (k\frac{\pi}{l}t)dt}\end{aligned}$$, $\begin{align} A_{k} \sin \psi_{k} = \frac{1}{l}\int_{- l}^{l} {f(t) \cos (k\frac{\pi}{l}t)dt} \end{align}$. 
